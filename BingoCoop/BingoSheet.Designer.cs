namespace BingoCoop
{
	partial class BingoSheet
	{
		...
		private void InitializeComponent()
		{
			...
			button1.Click += BingoButton_Click;
			// 
			// button2
			// 
			...
			button2.Click += BingoButton_Click;
			// 
			// button3
			// 
			...
			button3.Click += BingoButton_Click;
			// 
			// button4
			// 
			...
			button4.Click += BingoButton_Click;
			// 
			// button5
			// 
			...
			button5.Click += BingoButton_Click;
			// 
			// button6
			// 
			...
			button6.Click += BingoButton_Click;
			// 
			// button7
			// 
			...
			button7.Click += BingoButton_Click;
			// 
			// button8
			// 
			...
			button8.Click += BingoButton_Click;
			// 
			// button9
			// 
			...
			button9.Click += BingoButton_Click;
			// 
			// button10
			// 
			...
			button10.Click += BingoButton_Click;
			// 
			// button11
			// 
			...
			button11.Click += BingoButton_Click;
			// 
			// button12
			// 
			...
			button12.Click += BingoButton_Click;
			// 
			// button13
			// 
			...
			button13.Click += BingoButton_Click;
			// 
			// button14
			// 
			...
			button14.Click += BingoButton_Click;
			// 
			// button15
			// 
			...
			button15.Click += BingoButton_Click;
			// 
			// button16
			// 
			...
			button16.Click += BingoButton_Click;
			// 
			// button17
			// 
			...
			button17.Click += BingoButton_Click;
			// 
			// button18
			// 
			...
			button18.Click += BingoButton_Click;
			// 
			// button19
			// 
			...
			button19.Click += BingoButton_Click;
			// 
			// button20
			// 
			...
			button20.Click += BingoButton_Click;
			// 
			// button21
			// 
			...
			button21.Click += BingoButton_Click;
			// 
			// button22
			// 
			...
			button22.Click += BingoButton_Click;
			// 
			// button23
			// 
			...
			button23.Click += BingoButton_Click;
			// 
			// button24
			// 
			...
			button24.Size = new Size(100, 100);
			button24.TabIndex = 21;
			button24.Text = "button24";
			button24.UseVisualStyleBackColor = false;
			button24.Click += BingoButton_Click;
			// 
			// button25
			// 
			...
			button25.Size = new Size(100, 100);
			...
			playerNameLb.Location = new Point(546, 37);
			playerNameLb.Name = "playerNameLb";
			playerNameLb.Size = new Size(73, 17);
			playerNameLb.TabIndex = 25;
			playerNameLb.Text = "Your name:";
			// 
			// playerColorLb
			// 
			playerColorLb.AutoSize = true;
			playerColorLb.Location = new Point(546, 69);
			playerColorLb.Name = "playerColorLb";
			playerColorLb.Size = new Size(71, 17);
			playerColorLb.TabIndex = 26;
			playerColorLb.Text = "Your color:";
			// 
			// colorBtn
			// 
			...
			ClientSize = new Size(774, 566);
			Controls.Add(playerNameBtn);
			Controls.Add(colorBtn);
			Controls.Add(playerColorLb);
